...
const { uploadMovie, createMovieOrWebSeries, updateMovieOrWebSeries, getAllByFilter , getMovieOrSeriesById, getTrailerMovieOrSeriesById} = require("../controllers/movieWebSeriesController");
